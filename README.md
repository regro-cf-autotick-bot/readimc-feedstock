...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/readimc-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15154&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/readimc-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `readimc` can be installed with:

```
conda install readimc
```

It is possible to list all of the versions of `readimc` available on your platform with:
